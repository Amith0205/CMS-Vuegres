...
export default class Chat extends Component {
    ...
    handleClick=(e)=>{       
        ...
        {data[this.props.currIdx].Interactions.push(m)}
        this.setState(
            {
                message:"",
            }
            ...
            <article className="msg-container msg-remote" key={index}>
                <div className="msg-box">                        
                    ...
                    <div className="flr">
                        ...
                        <span className="timestamp"><span className="username">Name</span>&bull;<span className="posttime">{chats.createdAt}</span></span>
                    </div>
                    </div>
